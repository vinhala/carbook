...
4. App asks the user for the make, model, month and year of first registration, engine and current mileage of the car to add
...
2. App displays make, model, engine, year as well as a picture if provided
...
3. User edits make, model, engine, year, mileage, picture or documents
