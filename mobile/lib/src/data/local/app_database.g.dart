...
class $CarProfilesTable extends CarProfiles
  ...
  static const VerificationMeta _carSyncIdMeta = const VerificationMeta(
    'carSyncId',
  );
  @override
  late final GeneratedColumn<String> carSyncId = GeneratedColumn<String>(
    'car_sync_id',
    aliasedName,
    false,
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('car_sync_id')) {
      context.handle(
        _carSyncIdMeta,
        carSyncId.isAcceptableOrUnknown(data['car_sync_id']!, _carSyncIdMeta),
      );
    }
  ...
  CarProfileRecord map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return CarProfileRecord(
      ...
      carSyncId: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}car_sync_id'],
      )!,
...
class CarProfileRecord extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['car_sync_id'] = Variable<String>(carSyncId);
  ...
  factory CarProfileRecord.fromJson(
    ...
    return CarProfileRecord(
      ...
      carSyncId: serializer.fromJson<String>(json['carSyncId']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'carSyncId': serializer.toJson<String>(carSyncId),
  ...
  CarProfileRecord copyWith({
    ...
    id: id ?? this.id,
    carSyncId: carSyncId ?? this.carSyncId,
    make: make ?? this.make,
  ...
  CarProfileRecord copyWithCompanion(CarProfilesCompanion data) {
    return CarProfileRecord(
      ...
      carSyncId: data.carSyncId.present ? data.carSyncId.value : this.carSyncId,
  ...
  bool operator ==(Object other) =>
      ...
      (other is CarProfileRecord &&
          other.id == this.id &&
          other.carSyncId == this.carSyncId &&
...
class CarProfilesCompanion extends UpdateCompanion<CarProfileRecord> {
  ...
  const CarProfilesCompanion({
    ...
    this.carSyncId = const Value.absent(),
  ...
  static Insertable<CarProfileRecord> custom({
    ...
    return RawValuesInsertable({
      if (id != null) 'id': id,
      if (carSyncId != null) 'car_sync_id': carSyncId,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (carSyncId.present) {
      map['car_sync_id'] = Variable<String>(carSyncId.value);
    }
    if (make.present) {
...
class $WorkshopManualsTable extends WorkshopManuals
    with TableInfo<$WorkshopManualsTable, WorkshopManualRecord> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $WorkshopManualsTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
  ...
  static const VerificationMeta _backendManualIdMeta = const VerificationMeta(
    'backendManualId',
  );
  @override
  late final GeneratedColumn<String> backendManualId = GeneratedColumn<String>(
    'backend_manual_id',
    aliasedName,
    false,
    type: DriftSqlType.string,
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'workshop_manuals';
  @override
  VerificationContext validateIntegrity(
    Insertable<WorkshopManualRecord> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    ...
    if (data.containsKey('backend_manual_id')) {
      context.handle(
        _backendManualIdMeta,
        backendManualId.isAcceptableOrUnknown(
          data['backend_manual_id']!,
          _backendManualIdMeta,
        ),
      );
    } else if (isInserting) {
      context.missing(_backendManualIdMeta);
    }
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  WorkshopManualRecord map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return WorkshopManualRecord(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
        data['${effectivePrefix}id'],
      )!,
      ...
      backendManualId: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}backend_manual_id'],
      )!,
  ...
  @override
  $WorkshopManualsTable createAlias(String alias) {
    return $WorkshopManualsTable(attachedDatabase, alias);
  }
}

class WorkshopManualRecord extends DataClass
    implements Insertable<WorkshopManualRecord> {
  final int id;
  final int carProfileId;
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['id'] = Variable<int>(id);
    map['car_profile_id'] = Variable<int>(carProfileId);
    map['backend_manual_id'] = Variable<String>(backendManualId);
  ...
  WorkshopManualsCompanion toCompanion(bool nullToAbsent) {
    return WorkshopManualsCompanion(
      id: Value(id),
      carProfileId: Value(carProfileId),
      backendManualId: Value(backendManualId),
  ...
  factory WorkshopManualRecord.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return WorkshopManualRecord(
      id: serializer.fromJson<int>(json['id']),
      carProfileId: serializer.fromJson<int>(json['carProfileId']),
      backendManualId: serializer.fromJson<String>(json['backendManualId']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      'id': serializer.toJson<int>(id),
      'carProfileId': serializer.toJson<int>(carProfileId),
      'backendManualId': serializer.toJson<String>(backendManualId),
  ...
  WorkshopManualRecord copyWith({
    int? id,
    int? carProfileId,
    String? backendManualId,
    String? localPath,
    String? originalName,
    int? byteSize,
    DateTime? createdAt,
    ...
    id: id ?? this.id,
    carProfileId: carProfileId ?? this.carProfileId,
    backendManualId: backendManualId ?? this.backendManualId,
    localPath: localPath ?? this.localPath,
    originalName: originalName ?? this.originalName,
    byteSize: byteSize ?? this.byteSize,
    createdAt: createdAt ?? this.createdAt,
  );
  WorkshopManualRecord copyWithCompanion(WorkshopManualsCompanion data) {
    return WorkshopManualRecord(
      id: data.id.present ? data.id.value : this.id,
      carProfileId: data.carProfileId.present
          ? data.carProfileId.value
          : this.carProfileId,
      backendManualId: data.backendManualId.present
          ? data.backendManualId.value
          : this.backendManualId,
  ...
  @override
  String toString() {
    return (StringBuffer('WorkshopManualRecord(')
          ..write('id: $id, ')
          ..write('carProfileId: $carProfileId, ')
          ..write('backendManualId: $backendManualId, ')
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is WorkshopManualRecord &&
          other.id == this.id &&
          other.carProfileId == this.carProfileId &&
          other.backendManualId == this.backendManualId &&
...
class WorkshopManualsCompanion extends UpdateCompanion<WorkshopManualRecord> {
  final Value<int> id;
  final Value<int> carProfileId;
  final Value<String> backendManualId;
  final Value<String> localPath;
  final Value<String> originalName;
  final Value<int> byteSize;
  final Value<DateTime> createdAt;
  const WorkshopManualsCompanion({
    this.id = const Value.absent(),
    this.carProfileId = const Value.absent(),
    this.backendManualId = const Value.absent(),
  ...
  WorkshopManualsCompanion.insert({
    this.id = const Value.absent(),
    required int carProfileId,
    required String backendManualId,
    ...
    required DateTime createdAt,
       ...
       byteSize = Value(byteSize),
       createdAt = Value(createdAt);
  static Insertable<WorkshopManualRecord> custom({
    Expression<int>? id,
    Expression<int>? carProfileId,
    Expression<String>? backendManualId,
    ...
    return RawValuesInsertable({
      if (id != null) 'id': id,
      if (carProfileId != null) 'car_profile_id': carProfileId,
      if (backendManualId != null) 'backend_manual_id': backendManualId,
  ...
  WorkshopManualsCompanion copyWith({
    Value<int>? id,
    Value<int>? carProfileId,
    Value<String>? backendManualId,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (backendManualId.present) {
      map['backend_manual_id'] = Variable<String>(backendManualId.value);
    }
  ...
  @override
  String toString() {
    return (StringBuffer('WorkshopManualsCompanion(')
          ..write('id: $id, ')
          ..write('carProfileId: $carProfileId, ')
          ..write('backendManualId: $backendManualId, ')
          ..write('localPath: $localPath, ')
...
class AssistantConversationRecord extends DataClass
  ...
  @override
  int get hashCode =>
      Object.hash(id, carProfileId, conversationId, createdAt, updatedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class $AssistantMessagesTable extends AssistantMessages
  ...
  static const VerificationMeta _rejectionReasonCodeMeta =
      const VerificationMeta('rejectionReasonCode');
  @override
  late final GeneratedColumn<String> rejectionReasonCode =
      GeneratedColumn<String>(
...
class AssistantMessageRecord extends DataClass
  ...
  factory AssistantMessageRecord.fromJson(
    ...
    return AssistantMessageRecord(
      ...
      rejectionReasonCode: serializer.fromJson<String?>(
...
class AssistantMessagesCompanion
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (rejectionReasonCode.present) {
      map['rejection_reason_code'] = Variable<String>(
        rejectionReasonCode.value,
      );
    }
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $WorkshopManualsTable workshopManuals = $WorkshopManualsTable(
    this,
  );
  ...
  StreamQueryUpdateRules get streamUpdateRules => const StreamQueryUpdateRules([
    ...
    WritePropagation(
      ...
      result: [TableUpdate('workshop_manuals', kind: UpdateKind.delete)],
    ),
    WritePropagation(
      on: TableUpdateQuery.onTableName(
        'car_profiles',
      ...
      result: [TableUpdate('assistant_conversations', kind: UpdateKind.delete)],
    ),
    WritePropagation(
      on: TableUpdateQuery.onTableName(
        'car_profiles',
...
final class $$CarProfilesTableReferences
  ...
  static MultiTypedResultKey<$WorkshopManualsTable, List<WorkshopManualRecord>>
  _workshopManualsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.workshopManuals,
    aliasName: $_aliasNameGenerator(
      db.carProfiles.id,
      db.workshopManuals.carProfileId,
    ),
  );

  $$WorkshopManualsTableProcessedTableManager get workshopManualsRefs {
    final manager = $$WorkshopManualsTableTableManager(
      $_db,
      $_db.workshopManuals,
    ).filter((f) => f.carProfileId.id.sqlEquals($_itemColumn<int>('id')!));

    final cache = $_typedResult.readTableOrNull(
      _workshopManualsRefsTable($_db),
    );
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
  ...
  >
  _assistantConversationsRefsTable(_$AppDatabase db) =>
      MultiTypedResultKey.fromTable(
        db.assistantConversations,
        aliasName: $_aliasNameGenerator(
          db.carProfiles.id,
          db.assistantConversations.carProfileId,
        ),
      );

  $$AssistantConversationsTableProcessedTableManager
  get assistantConversationsRefs {
    ...
    final cache = $_typedResult.readTableOrNull(
      _assistantConversationsRefsTable($_db),
    );
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
  ...
  _assistantMessagesRefsTable(_$AppDatabase db) =>
      MultiTypedResultKey.fromTable(
        ...
        aliasName: $_aliasNameGenerator(
          db.carProfiles.id,
          db.assistantMessages.carProfileId,
        ),
      );
...
class $$CarProfilesTableFilterComposer
  ...
  ColumnFilters<String> get carSyncId => $composableBuilder(
    column: $table.carSyncId,
    builder: (column) => ColumnFilters(column),
  );
  ...
  Expression<bool> workshopManualsRefs(
    Expression<bool> Function($$WorkshopManualsTableFilterComposer f) f,
  ) {
    final $$WorkshopManualsTableFilterComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.workshopManuals,
      getReferencedColumn: (t) => t.carProfileId,
      builder:
          (
            joinBuilder, {
            $addJoinBuilderToRootComposer,
            $removeJoinBuilderFromRootComposer,
          }) => $$WorkshopManualsTableFilterComposer(
            $db: $db,
            $table: $db.workshopManuals,
            $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
            joinBuilder: joinBuilder,
            $removeJoinBuilderFromRootComposer:
                $removeJoinBuilderFromRootComposer,
  ...
  Expression<bool> assistantConversationsRefs(
    Expression<bool> Function($$AssistantConversationsTableFilterComposer f) f,
  ) {
...
class $$CarProfilesTableOrderingComposer
  ...
  ColumnOrderings<String> get carSyncId => $composableBuilder(
    column: $table.carSyncId,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$CarProfilesTableAnnotationComposer
  ...
  GeneratedColumn<String> get carSyncId =>
      $composableBuilder(column: $table.carSyncId, builder: (column) => column);
  ...
  Expression<T> workshopManualsRefs<T extends Object>(
    Expression<T> Function($$WorkshopManualsTableAnnotationComposer a) f,
  ) {
    final $$WorkshopManualsTableAnnotationComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.workshopManuals,
      getReferencedColumn: (t) => t.carProfileId,
      builder:
          (
            ...
            $addJoinBuilderToRootComposer,
            $removeJoinBuilderFromRootComposer,
          }) => $$WorkshopManualsTableAnnotationComposer(
            $db: $db,
            $table: $db.workshopManuals,
            $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
            joinBuilder: joinBuilder,
  ...
  Expression<T> assistantConversationsRefs<T extends Object>(
    Expression<T> Function($$AssistantConversationsTableAnnotationComposer a) f,
  ) {
    ...
    extends
        RootTableManager<
          ...
          PrefetchHooks Function({
            ...
            bool workshopManualsRefs,
            bool assistantConversationsRefs,
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                Value<String> carSyncId = const Value.absent(),
          ...
          prefetchHooksCallback:
              ({
                maintenanceItemsRefs = false,
                repairEntriesRefs = false,
                workshopManualsRefs = false,
                assistantConversationsRefs = false,
                ...
                return PrefetchHooks(
                  ...
                  explicitlyWatchedTables: [
                    ...
                    if (workshopManualsRefs) db.workshopManuals,
                    if (assistantConversationsRefs) db.assistantConversations,
                    ...
                    return [
                      ...
                      if (assistantConversationsRefs)
                        ...
                        >(
                          currentTable: table,
                          referencedTable: $$CarProfilesTableReferences
                              ._assistantConversationsRefsTable(db),
                          managerFromTypedResult: (p0) =>
                              $$CarProfilesTableReferences(
                                db,
                                table,
                                p0,
                              ).assistantConversationsRefs,
                          referencedItemsForCurrentItem:
                              (item, referencedItems) => referencedItems.where(
                                (e) => e.carProfileId == item.id,
                              ),
...
typedef $$RepairAttachmentsTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function({bool repairEntryId})
    >;
typedef $$WorkshopManualsTableCreateCompanionBuilder =
    WorkshopManualsCompanion Function({
      Value<int> id,
      required int carProfileId,
      required String backendManualId,
      required String localPath,
...
typedef $$WorkshopManualsTableUpdateCompanionBuilder =
    WorkshopManualsCompanion Function({
      Value<int> id,
      Value<int> carProfileId,
      Value<String> backendManualId,
...
final class $$WorkshopManualsTableReferences
    extends
        BaseReferences<
          _$AppDatabase,
          $WorkshopManualsTable,
          WorkshopManualRecord
        > {
  $$WorkshopManualsTableReferences(
    super.$_db,
    super.$_table,
    super.$_typedResult,
  );
...
class $$WorkshopManualsTableFilterComposer
    extends Composer<_$AppDatabase, $WorkshopManualsTable> {
  $$WorkshopManualsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
  ...
  ColumnFilters<String> get backendManualId => $composableBuilder(
    column: $table.backendManualId,
    builder: (column) => ColumnFilters(column),
  );
...
class $$WorkshopManualsTableOrderingComposer
    extends Composer<_$AppDatabase, $WorkshopManualsTable> {
  $$WorkshopManualsTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  ColumnOrderings<String> get backendManualId => $composableBuilder(
    column: $table.backendManualId,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$WorkshopManualsTableAnnotationComposer
    extends Composer<_$AppDatabase, $WorkshopManualsTable> {
  $$WorkshopManualsTableAnnotationComposer({
    required super.$db,
    required super.$table,
  ...
  GeneratedColumn<String> get backendManualId => $composableBuilder(
    column: $table.backendManualId,
    builder: (column) => column,
  );
...
class $$WorkshopManualsTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $WorkshopManualsTable,
          ...
          $$WorkshopManualsTableOrderingComposer,
          $$WorkshopManualsTableAnnotationComposer,
          $$WorkshopManualsTableCreateCompanionBuilder,
          $$WorkshopManualsTableUpdateCompanionBuilder,
          (WorkshopManualRecord, $$WorkshopManualsTableReferences),
          WorkshopManualRecord,
          PrefetchHooks Function({bool carProfileId})
        > {
  $$WorkshopManualsTableTableManager(
    _$AppDatabase db,
    $WorkshopManualsTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$WorkshopManualsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$WorkshopManualsTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$WorkshopManualsTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<int> id = const Value.absent(),
                Value<int> carProfileId = const Value.absent(),
                Value<String> backendManualId = const Value.absent(),
                Value<String> localPath = const Value.absent(),
                Value<String> originalName = const Value.absent(),
                Value<int> byteSize = const Value.absent(),
                Value<DateTime> createdAt = const Value.absent(),
              }) => WorkshopManualsCompanion(
                id: id,
                carProfileId: carProfileId,
                backendManualId: backendManualId,
                localPath: localPath,
                originalName: originalName,
                byteSize: byteSize,
                createdAt: createdAt,
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable(table),
                  $$WorkshopManualsTableReferences(db, table, e),
                ),
              )
              .toList(),
...
typedef $$WorkshopManualsTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $WorkshopManualsTable,
      WorkshopManualRecord,
...
class $$AssistantMessagesTableAnnotationComposer
  ...
  GeneratedColumn<String> get rejectionReasonCode => $composableBuilder(
    column: $table.rejectionReasonCode,
    builder: (column) => column,
  );
...
class $AppDatabaseManager {
  ...
  $$WorkshopManualsTableTableManager get workshopManuals =>
      $$WorkshopManualsTableTableManager(_db, _db.workshopManuals);
